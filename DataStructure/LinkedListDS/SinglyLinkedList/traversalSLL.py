...
singlyLL.insertSLL(7, 2)
singlyLL.insertSLL(5, 3)
singlyLL.insertSLL(1, 4)
singlyLL.insertSLL(0, 5)
singlyLL.insertSLL(7, 6)
singlyLL.insertSLL(5, 7)
singlyLL.insertSLL(1, 0)
singlyLL.insertSLL(4, 5)
singlyLL.insertSLL(3, -1)
print([node.value for node in singlyLL])
# Traversal call function
singlyLL.traversalLL()